...
function fPicker(){
  function fLoadContent() {
    ...
    if (!oElements.picker.reportsList) {
      ...
      aPostVars['custominternalreportname']=oCaller.formEl.internalReportName || oElements.picker.reportsList.options[oElements.picker.reportsList.selectedIndex].value;
    }
