...
# display application
cat /var/lib/tomcat7/webapps/agileBase/resources/display_application.css /var/lib/tomcat7/webapps/agileBase/resources/button/button.css > /var/lib/tomcat7/webapps/agileBase/resources/display_application_amalgam.css
# JS
# pane 1
...
find /var/lib/tomcat7/webapps/agileBase/resources/ -name '*.js' -print0 | xargs -0 java -jar /usr/local/agileBase/yuicompressor/yuicompressor.jar --line-break 0 --nomunge --preserve-semi -o '.js$:.js'
