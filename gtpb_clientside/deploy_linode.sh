...
find /var/lib/tomcat7/webapps/agileBase/resources/ --line-break 0 --nomunge --preserve-semi -name '*.js' -print0 | xargs -0 java -jar /usr/local/agileBase/yuicompressor/yuicompressor.jar -o '.js$:.js'
