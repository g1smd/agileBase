...
cat /var/lib/tomcat7/webapps/agileBase/resources/highcharts.js /var/lib/tomcat7/webapps/agileBase/resources/jquery.oembed.js /var/lib/tomcat7/webapps/agileBase/resources/jquery.tweet.js /var/lib/tomcat7/webapps/agileBase/resources/jquery.hoverIntent.js /var/lib/tomcat7/webapps/agileBase/resources/jquery.cluetip.js /var/lib/tomcat7/webapps/agileBase/resources/socket.io.js /var/lib/tomcat7/webapps/agileBase/resources/tree/tree.js > /var/lib/tomcat7/webapps/agileBase/resources/pane1_amalgam.js
# pane 2
...
find /var/lib/tomcat7/webapps/agileBase/resources/ -name '*.js' -print0 | xargs -0 ls {}; java -jar /usr/local/agileBase/yuicompressor/yuicompressor.jar --line-break 0 --nomunge --preserve-semi -o '.js$:.js' {}
