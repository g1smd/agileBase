...
# JS
# pane 1
cat /usr/local/tomcat/apache-tomcat/webapps/agileBase/resources/tree/tree.js /usr/local/tomcat/apache-tomcat/webapps/agileBase/resources/modalFramework/modalFramework.js /usr/local/tomcat/apache-tomcat/webapps/agileBase/resources/wait/request_setFilter.js > /usr/local/tomcat/apache-tomcat/webapps/agileBase/resources/mobile/pane1_amalgam.js
# pane 2
