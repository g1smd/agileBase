...
cat /usr/local/tomcat/apache-tomcat/webapps/agileBase/styles/report.css /usr/local/tomcat/apache-tomcat/webapps/agileBase/resources/tabs/tabs.css /usr/local/tomcat/apache-tomcat/webapps/agileBase/resources/jquery.autocomplete.css > /usr/local/tomcat/apache-tomcat/webapps/agileBase/resources/pane3_amalgam.css
# JS
# pane 1
...
cat /usr/local/tomcat/apache-tomcat/webapps/agileBase/resources/tree/tree.js /usr/local/tomcat/apache-tomcat/webapps/agileBase/resources/jquery.hoverIntent.js /usr/local/tomcat/apache-tomcat/webapps/agileBase/resources/jquery.cluetip.js > /usr/local/tomcat/apache-tomcat/webapps/agileBase/resources/pane1_amalgam.js
# pane 2
