...
public class DateFieldDefn extends AbstractField implements DateField {
    /**
     * Private constructor only used by the object database db4o Provided for performance reasons, see the
     * 'Tuning' section 21.2 of the db4o tutorial
     */
    protected DateFieldDefn() {
    }

    public DateFieldDefn(TableInfo tableContainingField, String internalFieldName, String fieldName, String fieldDesc, boolean unique, boolean notNull,
        ...
        super.setNotNullDirect(notNull); // TODO: Reference super.setNotNull() once a method of setting
    ...
    /**
     * Default format to correspond with default dateResolution is 01 Jan 2006 05:23
     */
