...
public class BigTextFieldDefn extends AbstractField implements TextField {
	...
	public BigTextFieldDefn(TableInfo tableContainingField, String internalFieldName,
			String fieldName, String fieldDesc, boolean notNull, String defaultValue)
	...
	/**
	 * Big text fields don't implement the 'not applicable' property at the
	 * moment
	 */
	@Transient
	...
	public void setUsesLookup(Boolean usesLookup) throws CantDoThatException {
		throw new CantDoThatException("You can't set the big text field " + this
				+ " to use a lookup");
	}
