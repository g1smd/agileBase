...
public final class ViewTools implements ViewToolsInfo {
	...
	public String getAreaForPhoneNumber(String phoneNumber) {
		if (this.areaCodes.isEmpty()) {
			...
			this.areaCodes.put("01229", "Barrow-in-Furness and Millom");
			this.areaCodes.put("01233", "Ashford, Kent");
			...
			this.areaCodes.put("01248", "Bangor, Gwynedd");
			...
			this.areaCodes.put("01257", "Coppull, Chorley");
			...
			this.areaCodes.put("01283", "Burton-on-Trent");
			...
			this.areaCodes.put("01289", "Berwick-upon-Tweed");
			...
			this.areaCodes.put("01354", "Chatteris and March, Cambridgeshire, Fenland");
			...
			this.areaCodes.put("01372", "Esher, Epsom");
			...
			this.areaCodes.put("01388", "Bishop Auckland, Durham and Stanhope (Eastgate)");
			...
			this.areaCodes.put("01482", "Kingston-upon-Hull");
			...
			this.areaCodes.put("01507", "Alford (Lincs), Louth and Spilsby (Horncastle)");
			...
			this.areaCodes.put("01707", "Welwyn Garden City, Hatfield and Potters Bar");
			...
			this.areaCodes.put("01833", "Barnard Castle, Teesdale");
			...
			this.areaCodes.put("01841", "Padstow, Newquay");
			...
			this.areaCodes.put("01864", "Tinto, Abington, Crawford");
			this.areaCodes.put("01865", "Oxford");
			...
			this.areaCodes.put("01889", "Rugeley, Uttoxeter");
			...
			this.areaCodes.put("01984", "Watchet, Williton");
			...
			this.areaCodes.put("0870", "Non geographic/special");
