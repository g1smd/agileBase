...
public class Enumerations {
	...
	public enum SessionAction {
		SET_MODULE, PRESET_ROW_ID, SET_TABLE, SET_REPORT, SET_ROW_ID, NEXT_ROW_ID, PREVIOUS_ROW_ID, SET_REPORT_ROW_LIMIT, SET_REPORT_FILTER_VALUE, CLEAR_REPORT_FILTER_VALUE, CLEAR_ALL_REPORT_FILTER_VALUES, CLEAR_ALL_REPORT_SORTS, CLEAR_REPORT_SORT, SET_REPORT_SORT, SET_USER, SET_ROLE, SET_CONTEXT, SET_CUSTOM_VARIABLE, SET_CUSTOM_STRING, SET_CUSTOM_INTEGER, SET_CUSTOM_LONG, SET_CUSTOM_BOOLEAN, SET_CUSTOM_TABLE, SET_CUSTOM_REPORT, SET_CUSTOM_FIELD, CLEAR_CUSTOM_VARIABLE, POSTSET_TABLE, POSTSET_REPORT, POSTSET_CUSTOM_TABLE, POSTSET_CUSTOM_REPORT, SET_LOCK_OVERRIDE, LOGOUT
	}
