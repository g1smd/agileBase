...
public class Enumerations {
	...
	public enum Browsers {
		MSIE("Internet Explorer", "msie"), FIREFOX("Firefox", "firefox"), MINEFIELD(
				...
				"Opera", "opera"), IPOD("iPod", "ipod"), IPHONE("iPhone", "iphone"), IPAD("iPad", "ipad"),
