...
import com.gtwm.pb.auth.UserObjectPrivilege;
import com.gtwm.pb.auth.RoleObjectPrivilege;
...
public class HibernateUtil {
	...
	static {
		try {
			...
			cfg.addAnnotatedClass(RoleObjectPrivilege.class);
			cfg.addAnnotatedClass(UserObjectPrivilege.class);
