...
public final class HibernateUtil {
	...
	static {
		try {
			...
			configuration.addAnnotatedClass(CommentStreamTile.class);
			configuration.addAnnotatedClass(DataLinkTile.class);
			configuration.addAnnotatedClass(DataStreamTile.class);
